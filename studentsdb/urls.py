...
urlpatterns = patterns(
    ...
    url(r'^students/add/$',
        permission_required('students.add_student')(students_add),
        name='students_add'),
    ...
    url(r'^students/delete-bunch/$',
        permission_required('students.delete_student')(students_delete_bunch),
        name="students_delete_bunch"),
    ...
    url(r'^groups/(?P<pk>\d+)/delete/$',
        login_required(permission_required(
            'students.delete_group',
            raise_exception=True)(GroupDeleteView.as_view())),
        name='group_delete'),
    ...
    # Action List
    url(r'^action-journal/$',
        login_required(ActionListView.as_view()), name='action_journal'),
    ...
    # url(r'^users/profile/(?P<username>[a-zA-Z@+-_.0-9]+)/$',
    #     login_required(UserDetailView.as_view()), name='user_profile'),
    url(r'^users/profile/(?P<pk>\d+)/$',
        login_required(UserDetailView.as_view()), name='user_profile'),
    url(r'^users/profile/edit/$',
        login_required(UserUpdateView.as_view()), name='user_profile_edit'),
    url(r'^users/logout/$',
        auth_views.logout, kwargs={'next_page': 'home'}, name='auth_logout'),
    ...
    url(r'^users/password_reset/$',
        auth_views.password_reset, name='auth_password_reset'),
